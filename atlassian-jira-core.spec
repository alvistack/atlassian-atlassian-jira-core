...
JIRA_DOWNLOAD_URL=http://product-downloads.atlassian.com/software/jira/downloads/atlassian-jira-core-9.4.27.tar.gz
JIRA_DOWNLOAD_DEST=/tmp/atlassian-jira-core-9.4.27.tar.gz
